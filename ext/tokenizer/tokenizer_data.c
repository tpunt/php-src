...
void tokenizer_register_constants(INIT_FUNC_ARGS) {
	...
	REGISTER_LONG_CONSTANT("T_PRINTLN", T_PRINTLN, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("T_ECHOLN", T_ECHOLN, CONST_CS | CONST_PERSISTENT);
